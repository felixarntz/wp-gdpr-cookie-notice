...
$autoloader->register_rule( 'Leaves_And_Love\\WP_GDPR_Cookie_Notice', $basedir );
$autoloader->register_rule( 'Leaves_And_Love\\WP_GDPR_Cookie_Notice\\Contracts', $basedir . '/contracts', Leaves_And_Love\WP_GDPR_Cookie_Notice\Autoloader::TYPE_INTERFACE );
