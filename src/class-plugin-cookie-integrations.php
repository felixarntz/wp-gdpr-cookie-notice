...
use Felix_Arntz\WP_GDPR_Cookie_Notice\Cookie_Integrations\Site_Kit_AdSense_Cookie_Integration;
use Felix_Arntz\WP_GDPR_Cookie_Notice\Cookie_Integrations\Site_Kit_Analytics_Cookie_Integration;
...
class Plugin_Cookie_Integrations implements Integration {
	...
	protected function get_default_cookie_integrations() : array {
		$integrations = [
			...
			new Site_Kit_AdSense_Cookie_Integration(),
			new Site_Kit_Analytics_Cookie_Integration(),
