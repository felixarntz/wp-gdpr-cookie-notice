<?php
/**
 * Leaves_And_Love\WP_GDPR_Cookie_Notice\Customizer\Number_Customizer_Control class
 *
...
/**
 * Class representing a number Customizer control.
 *
 * @since 1.0.0
 */
class Number_Customizer_Control extends Abstract_Customizer_Control {
