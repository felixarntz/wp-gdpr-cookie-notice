<?php
/**
 * Felix_Arntz\WP_GDPR_Cookie_Notice\Cookie_Integrations\Site_Kit_AdSense_Cookie_Integration class
 *
...
/**
 * Class representing a cookie integration for AdSense in the "Site Kit by Google" plugin.
 *
 * @since 1.0.0
 */
class Site_Kit_AdSense_Cookie_Integration implements Cookie_Integration {
	use Is_AMP;
	...
	final public function get_id() : string {
		return 'google_site_kit_adsense';
	}
	...
	final public function get_type() : string {
		return Cookie_Type_Enum::TYPE_MARKETING;
	}
	...
	public function get_enable_label() : string {
		return __( 'Block Google AdSense (Site Kit by Google plugin) from tracking visitors?', 'wp-gdpr-cookie-notice' );
	}
