<?php
/**
 * Felix_Arntz\WP_GDPR_Cookie_Notice\Cookie_Integrations\WordPress_Auth_Cookie_Integration class
 *
...
class WordPress_Auth_Cookie_Integration implements Cookie_Integration {
	...
	public function get_enable_label() : string {
		return __( 'Block users from logging in to the backend?', 'wp-gdpr-cookie-notice' );
	}
