# Contribute to WP GDPR Cookie Notice
...
* [open an issue](https://github.com/felixarntz/wp-gdpr-cookie-notice/issues/new)
...
* push the changes to your fork and [submit a pull request](https://github.com/felixarntz/wp-gdpr-cookie-notice/compare) to the `master` branch
...
* visit our project on [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/wp-gdpr-cookie-notice) and sign in with your wordpress.org account (create one if you haven't yet)
